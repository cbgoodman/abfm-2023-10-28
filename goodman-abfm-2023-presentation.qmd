...
analysis_vars$d_race = labelled(analysis_vars$d_race, label = "Race index")
...
datasummary(
    fpi_mean + functions + mrp_estimate + pop1000 + mhi_def + mhp_def + d_race + muniage ~ Mean + SD + Min + Max,
    data = analysis_vars,
    align = "lrrrr",
    fmt = 2,
    output = 'gt') %>%
